...
# geht ins nirwana
echo "JEFF: mount.sh starts "
echo "JEFF: mount.sh starts STIN" >&1

# siehe /var/log/auth.log
# siehe /var/log/gdm:0-slave.log
DATE=`date`
echo "JEFF: ######################################################################" >&2
echo "JEFF: umount.sh starts on $DATE   -> STERR" >&2
echo "JEFF: ######################################################################" >&2
